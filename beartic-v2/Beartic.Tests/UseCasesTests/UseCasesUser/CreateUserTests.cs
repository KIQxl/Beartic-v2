...
namespace Beartic.Tests.UseCasesTests.UseCasesUser
{
    ...
    public class CreateUserTests
    {
        ...
        public void GivenValidRequestReturnResultStatus201()
        {
            ...
            var request = new CreateUserDto("user1", "kaique", "alves", "email@teste.com", "65950707079", EDocumentType.CPF, "11922113322", "123456789", new List<string> { "123" });
        ...
        {
            var services = new UserServices(_userRepository, _roleRepository);
            var request = new CreateUserDto("user1", "kaique", "alves", "exists@email.com", "65950707079", EDocumentType.CPF, "11922113322", "123456789", new List<string> { "123", "12", "1" });
            var response = services.Create(request);
